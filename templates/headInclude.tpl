...
{if !$metaDescription|empty}<meta name="description" content="{$metaDescription}" />{/if}
{if !$metaKeywords|empty}<meta name="keywords" content="{$metaKeywords}" />{/if}
...
<!-- wsip styles -->
<link rel="stylesheet" type="text/css" media="screen" href="{@RELATIVE_WSIP_DIR}style/wsip{if PAGE_DIRECTION == 'rtl'}-rtl{/if}.css" />
{if $this->getStyle()->getVariable('page.frame.general') == ''}
	<style type="text/css">
		#mainContainer {
			{$this->getStyle()->getVariable('page.alignment.margin')}{if $this->getStyle()->getVariable('page.width') !== ''}width:{$this->getStyle()->getVariable('page.width')}{else}max-width:{$this->getStyle()->getVariable('page.width.max')};min-width:{$this->getStyle()->getVariable('page.width.min')};{/if}
		}
	</style>
{/if}
...
<link rel="stylesheet" type="text/css" media="print" href="{@RELATIVE_WSIP_DIR}style/print{if PAGE_DIRECTION == 'rtl'}-rtl{/if}.css" />
...
<script type="text/javascript">
	...
	var RELATIVE_WSIP_DIR = '{@RELATIVE_WSIP_DIR}';
