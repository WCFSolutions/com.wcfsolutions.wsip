...
class CategoryListPage extends AbstractPage {
	...
	public $neededPermissions = array('admin.portal.canEditCategory', 'admin.portal.canDeleteCategory');
	...
	public function show() {
		...
		WCFACP::getMenu()->setActiveMenuItem('wsip.acp.menu.link.content.category.view');
