...
/**
 * Shows the welcome page in the portal admin control panel.
 *
...
class IndexPage extends AbstractPage {
	...
	protected function readStat() {
		WCF::getCache()->addResource('acpstat', WSIP_DIR.'cache/cache.acpstat.php', WSIP_DIR.'lib/system/cache/CacheBuilderACPStat.class.php', 0, 3600 * 12);
